...
def sort_name(books_list):
    ...
    print("""
        ...
        des - descending
    """)
    order = validate_input_string('Choose sorting order: ', "Please only choose between 'asc' or 'des'!", ['asc', 'des'])
...
def sort(books_list):
    ...
    sort_type = validate_input_string('Choose sorting type: ', "Please only choose between 'name', 'author' or 'price'!", ['name', 'author', 'price'])
    if sort_type == 'name':
