...
def sort_name(books_list):
    ...
    print('\nPlease choose to sort books by name in descending or ascending order.')
    print("""
        asc - ascending
        des - descending
    """)
    ...
    order = validate_input_string('Choose sorting order: ', "\nPlease only choose between 'asc' or 'des'!",
                                  ['asc', 'des'])
...
def sort_author(books_list):
    ...
    print('\nPlease choose to sort books by author in descending or ascending order.')
    print("""
        asc - ascending
        des - descending
    """)
...
def sort_price(books_list):
    ...
    :return: None
    """
    print('\nPlease choose to sort books by price in descending or ascending order.')
    print("""
        asc - ascending
        des - descending
    """)
...
def sort():
    ...
    print('\nPlease choose to sort books by name, author or price.')
