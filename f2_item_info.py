...
def book_info():
    """
    This function will provide all the information of a specific book (including name, author, genre, number of pages,
    ...
    # Identify the chosen book in the book list
    ...
    print('Average ratings:', selected_book['average_rate'],
